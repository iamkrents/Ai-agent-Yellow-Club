...
> Последнее обновление: 2026-07-15 (v7.0.93.1)
...
| Последний коммит в `main` | **v7.0.93.1** — Add separate client parent links |
| Frontend cache-bust | **`v=7.0.93.1`** (app.js и styles.css) |
| `console.log` в app.js | `MiniApp version: v7.0.93.1` |
