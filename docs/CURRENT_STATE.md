...
> РџРѕСЃР»РµРґРЅРµРµ РѕР±РЅРѕРІР»РµРЅРёРµ: 2026-07-18 (v7.0.94.3)
...
| РџРѕСЃР»РµРґРЅРёР№ РєРѕРјРјРёС‚ РІ `main` | **v7.0.94.3** вЂ” Automated MoyKlass invoice detection and payment preparation pipeline |
| Frontend cache-bust | **`v=7.0.94.2`** (app.js Рё styles.css) |
| `console.log` РІ app.js | `MiniApp version: v7.0.94.3` |
