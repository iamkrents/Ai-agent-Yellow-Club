...
> Последнее обновление: 2026-07-17 (v7.0.94.0)
...
| Последний коммит в `main` | **v7.0.94.0** — Automated MoyKlass invoice detection and payment preparation pipeline |
| Frontend cache-bust | **`v=7.0.94.0`** (app.js и styles.css) |
| `console.log` в app.js | `MiniApp version: v7.0.94.0` |
