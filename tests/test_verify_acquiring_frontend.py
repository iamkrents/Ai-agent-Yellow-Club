...
class Test05VersionAndCacheBust(unittest.TestCase):
    ...
    def test_18_version_is_current(self):
        """app.js version marker is v7.0.93.2.2."""
        self.assertIn("v7.0.93.2.2", self.js)

    def test_19_cache_bust_is_current(self):
        """index.html cache-bust parameter is v=7.0.93.2.2."""
        self.assertIn("v=7.0.93.2.2", self.html)
