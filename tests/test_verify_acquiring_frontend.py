...
class Test05VersionAndCacheBust(unittest.TestCase):
    """Version marker and cache-bust updated to v7.0.92.5.4."""
    ...
    def test_18_version_is_92_5_4(self):
        """app.js version marker is v7.0.92.5.4."""
        self.assertIn("v7.0.92.5.4", self.js)

    def test_19_cache_bust_is_92_5_4(self):
        """index.html cache-bust parameter is v=7.0.92.5.4."""
