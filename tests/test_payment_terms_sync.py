...
class Test16V7121Static(unittest.TestCase):
    ...
    def test_70_cache_bust_v714(self):
        ...
        self.assertIn("v=7.1.9", self.html,
                      "index.html cache-bust must be v=7.1.9")
        self.assertIn("v7.1.9", self.js,
                      "app.js version marker must contain v7.1.9")
...
class Test17PilotAllowlist(unittest.TestCase):
    ...
    def test_95_cache_bust_v714(self):
        ...
        self.assertIn("v=7.1.9", self.html, "index.html cache-bust must be v=7.1.9")
        self.assertIn("v7.1.9", self.js, "app.js version must be v7.1.9")
