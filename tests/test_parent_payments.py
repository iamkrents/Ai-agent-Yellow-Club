...
class TestFrontend(unittest.TestCase):
    ...
    def test_17_version_marker_v7_0_93_2(self):
        self.assertIn('console.log("MiniApp version: v7.0.93.2")', self.js)

    def test_18_cache_bust_v7_0_93_2(self):
        self.assertIn("v=7.0.93.2", self.html)
