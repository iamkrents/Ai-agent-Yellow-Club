...
class TestRemoteCancelV714(unittest.TestCase):
    ...
    def test_127_cache_bust_v714(self):
        """index.html has v=7.1.9 and app.js has MiniApp version: v7.1.8."""
        html = (ROOT / "miniapp" / "index.html").read_text(encoding="utf-8")
        js = (ROOT / "miniapp" / "app.js").read_text(encoding="utf-8")
        self.assertIn("v=7.1.9", html, "index.html cache-bust must be v=7.1.9")
        self.assertIn("v7.1.9", js, "app.js version marker must contain v7.1.9")
