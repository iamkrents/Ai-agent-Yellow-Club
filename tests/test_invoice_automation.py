...
def _make_ctx_with_mocks(storage: Storage, invoices: list[dict]):
    ...
    # v7.1.8 — training-state gate stub: pre-existing pipeline tests assume the
    # student is active; the gate is covered separately in
...
class TestAutomationHTMLStatic(unittest.TestCase):
    ...
    def test_moyklass_auto_post_disabled_label(self):
        # v7.0.96.1: functional auto-post toggle replaces old disabled placeholder
